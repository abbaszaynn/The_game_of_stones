...
const galleryImages: GalleryImage[] = [
    { id: 'gal-1', url: 'https://images.unsplash.com/photo-1588152763435-0de3c7bf35f6?q=80&w=1974', title: 'Raw Amethyst Geode', description: 'A stunning, vibrant purple amethyst geode formation.', companyName: 'Durr Mines and Minerals', mineral: 'Amethyst', properties: 'Quartz variety, known for its violet color.' },
    { id: 'gal-2', url: 'https://images.unsplash.com/photo-1617393439972-8501a2434a93?q=80&w=1964', title: 'Rough Azurite Mineral', description: 'Deep blue azurite crystals on a rock matrix.', companyName: 'Durr Mines and Minerals', mineral: 'Azurite', properties: 'A soft, deep-blue copper mineral.' },
    { id: 'gal-3', url: 'https://images.unsplash.com/photo-1620188460115-d72b07f8a964?q=80&w=1974', title: 'Crystalline Bismuth', description: 'Iridescent, staircase-like bismuth crystals.', companyName: 'Durr Mines and Minerals', mineral: 'Bismuth', properties: 'Brittle metal with a silvery-white color and an iridescent oxide tarnish.' },
    { id: 'gal-4', url: 'https://images.unsplash.com/photo-1590422157596-f6c6a666f272?q=80&w=1974', title: 'Pyrite Cluster', description: 'A dense cluster of metallic golden pyrite crystals.', companyName: 'Durr Mines and Minerals', mineral: 'Pyrite', properties: 'Iron sulfide mineral, also known as "Fool\'s Gold".' },
    { id: 'gal-5', url: 'https://images.unsplash.com/photo-1620188526398-9e579934e23c?q=80&w=1974', title: 'Polished Malachite', description: 'A polished slice of malachite with intricate banding.', companyName: 'Durr Mines and Minerals', mineral: 'Malachite', properties: 'A green copper carbonate hydroxide mineral.' },
    { id: 'gal-6', url: 'https://images.unsplash.com/photo-1604187351543-03e583489851?q=80&w=1974', title: 'Rose Quartz', description: 'A large, translucent piece of raw rose quartz.', companyName: 'Durr Mines and Minerals', mineral: 'Rose Quartz', properties: 'A variety of quartz with a pale pink to rose red hue.' },
    { id: 'gal-7', url: 'https://images.unsplash.com/photo-1589935447047-bf37b37f3747?q=80&w=1974', title: 'Tourmaline Crystals', description: 'Black tourmaline crystals embedded in a quartz matrix.', companyName: 'Durr Mines and Minerals', mineral: 'Tourmaline', properties: 'A crystalline boron silicate mineral.' },
    { id: 'gal-8', url: 'https://images.unsplash.com/photo-1616450639910-3c22b97f9c2d?q=80&w=1974', title: 'Labradorite Slab', description: 'A slab of labradorite showing its characteristic labradorescence.', companyName: 'Durr Mines and Minerals', mineral: 'Labradorite', properties: 'Feldspar mineral known for its iridescent optical effect.' },
    { id: 'gal-9', url: 'https://images.unsplash.com/photo-1629814467368-a4e320ab1621?q=80&w=1968', title: 'Raw Fluorite Octahedron', description: 'A natural, unpolished fluorite crystal with an octahedron shape.', companyName: 'Durr Mines and Minerals', mineral: 'Fluorite', properties: 'A halide mineral composed of calcium fluoride.' },
    { id: 'gal-10', url: 'https://images.unsplash.com/photo-1588152755160-4f964a2c14c5?q=80&w=1974', title: 'Chrysocolla Specimen', description: 'A vibrant blue and green chrysocolla mineral specimen.', companyName: 'Durr Mines and Minerals', mineral: 'Chrysocolla', properties: 'A hydrated copper phyllosilicate mineral.' },
    { id: 'gal-11', url: 'https://images.unsplash.com/photo-1525542813454-b336369e8557?q=80&w=1974', title: 'Citrine Crystal', description: 'A yellow citrine quartz crystal.', companyName: 'Durr Mines and Minerals', mineral: 'Citrine', properties: 'A variety of quartz whose color ranges from a pale yellow to brown.' },
    { id: 'gal-12', url: 'https://images.unsplash.com/photo-1615147321523-a5539c362058?q=80&w=2070', title: 'Opal', description: 'A colorful precious opal.', companyName: 'Durr Mines and Minerals', mineral: 'Opal' },
    { id: 'gal-13', url: 'https://images.unsplash.com/photo-1610486036899-7901b0f5854b?q=80&w=1974', title: 'Garnet', description: 'A red garnet crystal.', companyName: 'Durr Mines and Minerals', mineral: 'Garnet' },
    { id: 'gal-14', url: 'https://images.unsplash.com/photo-1598585461494-0a619861e8a3?q=80&w=2070', title: 'Agate', description: 'A slice of agate with beautiful banding.', companyName: 'Durr Mines and Minerals', mineral: 'Agate' }
];
...
const companies: Company[] = [
  {
    ...
    images: [
        'https://images.unsplash.com/photo-1588152763435-0de3c7bf35f6?q=80&w=1974',
        'https://images.unsplash.com/photo-1617393439972-8501a2434a93?q=80&w=1964',
        'https://images.unsplash.com/photo-1620188460115-d72b07f8a964?q=80&w=1974',
        'https://images.unsplash.com/photo-1590422157596-f6c6a666f272?q=80&w=1974',
        'https://images.unsplash.com/photo-1620188526398-9e579934e23c?q=80&w=1974',
        'https://images.unsplash.com/photo-1604187351543-03e583489851?q=80&w=1974',
        'https://images.unsplash.com/photo-1589935447047-bf37b37f3747?q=80&w=1974',
        'https://images.unsplash.com/photo-1616450639910-3c22b97f9c2d?q=80&w=1974',
        'https://images.unsplash.com/photo-1629814467368-a4e320ab1621?q=80&w=1968',
        'https://images.unsplash.com/photo-1588152755160-4f964a2c14c5?q=80&w=1974',
        'https://images.unsplash.com/photo-1525542813454-b336369e8557?q=80&w=1974',
        'https://images.unsplash.com/photo-1615147321523-a5539c362058?q=80&w=2070',
        'https://images.unsplash.com/photo-1610486036899-7901b0f5854b?q=80&w=1974',
        'https://images.unsplash.com/photo-1598585461494-0a619861e8a3?q=80&w=2070'
    ],
